...
class FormularioNuevoProblema(forms.ModelForm):
    class Meta:
        model = Problema
        fields = ('titulo', 'materia', 'descripcion',
                   'telefonoContacto', 'emailContacto', 'imagenInstrumento')
...
class ActualizacionProblema(forms.ModelForm):
    class Meta:
        model = Problema
        fields = ('titulo', 'materia', 'descripcion',
                   'telefonoContacto', 'emailContacto', 'imagenInstrumento')
